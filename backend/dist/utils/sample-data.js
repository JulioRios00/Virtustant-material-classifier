...
exports.largeSampleBookings = exports.sampleBookings = void 0;
...
exports.largeSampleBookings = Array.from({ length: 100 }, (_, index) => {
    const baseBooking = exports.sampleBookings[index % exports.sampleBookings.length];
    return {
        ...baseBooking,
